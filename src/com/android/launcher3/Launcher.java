...
public final class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Launcher.HOME_SHARED_PREFERENCES_LOCAL,  
  
        Context.MODE_PRIVATE);  
  
        booleanisBooted = false;  
  
        try{  
  
           isBooted =preference.getBoolean(Launcher.PREF_BOOTED_ALREADY,false);  
       ...
       try{  
           ...
           mAnimatorDurationScale= windowManager.getAnimationScale(ANIMATOR_DURATION_NO);  
    ...
    if( FeatMac.FEAT_CARRIER== FeatMac.FEAT_CARRIER_KDDI ) {  
        ...
        Uri.parse("content://com.kddi.android.email.maildb.provider"),  
  
        true,mIspLogObserver);  
